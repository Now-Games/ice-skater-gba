...
//	+ 89 tiles (t|f reduced) not compressed
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item pause_scene(
            regular_bg_tiles_item(span<const tile>(pause_scene_bn_gfxTiles, 178), bpp_mode::BPP_8, compression_type::NONE), 
            bg_palette_item(span<const color>(pause_scene_bn_gfxPal, 64), bpp_mode::BPP_8, compression_type::NONE),
            regular_bg_map_item(pause_scene_bn_gfxMap[0], size(32, 32), compression_type::NONE));
}
