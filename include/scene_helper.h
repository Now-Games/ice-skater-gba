    ...
    static GameSceneDetails* getSceneDetails(int sceneIndex)
    {
        ...
        switch (sceneIndex)
        {
            ...
            case B22_SCENE:
                ...
                break;
            case B23_SCENE:
                details = new GameSceneDetails(B23_SCENE);
                details->levelName = "B23";
                details->sceneType = SceneType::Normal;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(80, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B24_SCENE_1;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-64, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWallCracked, bn::point(-16, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-64, -56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-48, -24), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(96, -8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(64, 24), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(96, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-112, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::CrackedIce, bn::point(80, 24), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Snowball, bn::point(-32, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(32, -56), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-96, -8), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Snow, bn::point(0, 72), Direction::Down});
                break;
            case B24_SCENE_1:
            {
                bn::vector<int, 5> floors;
                floors.push_back(B24_SCENE_1);
                floors.push_back(B24_SCENE_2);
                details = new MultiSceneDetails(B24_SCENE_1, floors);
                details->levelName = "B24";
                details->sceneType = SceneType::MultiLevel;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(80, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B25_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-64, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWallCracked, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWallCracked, bn::point(80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(0, -56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(0, -40), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-96, 40), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-64, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(64, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(-32, -24), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(-64, -24), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(32, -24), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(64, -24), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(16, -56), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-16, -56), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Snow, bn::point(0, 72), Direction::Down});
                break;
            }
            case B24_SCENE_2:
            {
                ...
                floors.push_back(B24_SCENE_1);
                floors.push_back(B24_SCENE_2);
                details = new MultiSceneDetails(B24_SCENE_2, floors);
                details->levelName = "B24";
                details->sceneType = SceneType::MultiLevel;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(180, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B25_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(0, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-48, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(48, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, -24), Direction::Up});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(16, 24), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-16, 24), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(-64, -24), Direction::Up});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(64, -24), Direction::Up});
                break;
            }
            case B25_SCENE:
                details = new GameSceneDetails(B25_SCENE);
                details->levelName = "B25";
                details->sceneType = SceneType::Normal;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(0, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B26_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-64, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(32, -56), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(64, -40), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(96, 0), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-16, 40), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-64, 24), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Snow, bn::point(0, 72), Direction::Down});
                break;
            case B26_SCENE:
                details = new EventSceneDetails(B26_SCENE, "It shouldnt be too much further now!");
                details->levelName = "B26";
                details->sceneType = SceneType::Tutorial;
                details->startPosition = bn::point(0, 40);
                details->exitPosition = bn::point(0, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B27_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-64, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-80, 8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(80, 8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, -56), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, -40), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Snow, bn::point(0, 40), Direction::Down});
                break;
            case B27_SCENE:
                details = new GameSceneDetails(B27_SCENE);
                details->levelName = "B27";
                details->sceneType = SceneType::Normal;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(0, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B28_SCENE_1;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-64, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(0, 40), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(96, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(48, -56), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-80, -8), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(80, 24), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Snow, bn::point(0, 72), Direction::Down});
                break;
            case B28_SCENE_1:
            {
                bn::vector<int, 5> floors;
                floors.push_back(B28_SCENE_1);
                floors.push_back(B28_SCENE_2);
                floors.push_back(B28_SCENE_3);
                floors.push_back(B28_SCENE_4);
                details = new MultiSceneDetails(B28_SCENE_1, floors);
                details->levelName = "B28";
                details->sceneType = SceneType::MultiLevel;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(-112, -8);
                details->exitDirection = Direction::Right;
                details->nextScene = B29_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -56), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -40), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -24), Direction::Right});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-16, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(16, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, -56), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, -24), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, 8), Direction::Right});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(0, 40), Direction::Left});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(0, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(112, -8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Snow, bn::point(0, 72), Direction::Down});
                break;
            }
            case B28_SCENE_2:
            {
                ...
                floors.push_back(B28_SCENE_3);
                floors.push_back(B28_SCENE_4);
                details = new MultiSceneDetails(B28_SCENE_2, floors);
                details->levelName = "B28";
                details->sceneType = SceneType::MultiLevel;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(-182, -8);
                details->exitDirection = Direction::Down;
                details->nextScene = B29_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(-16, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(16, -72), Direction::Down});
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(32, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(80, 40), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-80, -8), Direction::Up});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(-32, -8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(32, -8), Direction::Up});
                details->gameObjectDetails.push_back({GameObjectType::Shuriken, bn::point(80, -8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(0, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(-112, -8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(112, -8), Direction::Up});
                break;
            }
            case B28_SCENE_3:
            {
                ...
                floors.push_back(B28_SCENE_3);
                floors.push_back(B28_SCENE_4);
                details = new MultiSceneDetails(B28_SCENE_3, floors);
                details->levelName = "B28";
                details->sceneType = SceneType::MultiLevel;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(-182, -8);
                ...
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(0, 56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::IceRock, bn::point(112, 72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::CrackedIce, bn::point(112, -56), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::CrackedIce, bn::point(-64, -8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::CrackedIce, bn::point(112, 8), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(0, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(-112, -8), Direction::Up});
                details->gameObjectDetails.push_back({GameObjectType::Stairs, bn::point(112, -8), Direction::Down});
                break;
            ...
            case B28_SCENE_4:
            {
                ...
                floors.push_back(B28_SCENE_3);
                floors.push_back(B28_SCENE_4);
                details = new MultiSceneDetails(B28_SCENE_4, floors);
                details->levelName = "B28";
                details->sceneType = SceneType::MultiLevel;
                details->startPosition = bn::point(0, 72);
                details->exitPosition = bn::point(-182, -8);
            ...
            case B29_SCENE:
                details = new EventSceneDetails(B29_SCENE, "This is it. It should be just beyond this room.");
                details->levelName = "B29";
                details->sceneType = SceneType::Tutorial;
                details->startPosition = bn::point(0, 40);
                details->exitPosition = bn::point(0, -72);
                details->exitDirection = Direction::Down;
                details->nextScene = B30_SCENE;
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-112, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-96, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-80, -72), Direction::Down});
                details->gameObjectDetails.push_back({GameObjectType::RockWall, bn::point(-64, -72), Direction::Down});
                ...
                break;
            case B30_SCENE:
                details = new GameSceneDetails(B30_SCENE);
                details->levelName = "B30";
                break;
            default:
                break;
        }
